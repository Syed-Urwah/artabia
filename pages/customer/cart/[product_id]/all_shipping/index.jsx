        ...
        try {
          ...
          if (data.status === "true") {
            setAddress((prevAddresses) =>
              prevAddresses.filter((address) => address.addr_pk !== addr_pk)
            );
          }
        } catch (error) {
          console.log(error);
    ...
    <Layout>
      <div className="lg:px-16 px-4 py-16">
                ...
                >
                  <label className="flex items-center">
                    ...
                    <input
                      ...
                      onChange={() =>
                        handleSelectAddress(index + 1, addrs.addr_pk)
                      }
                      className="mr-2"
                    />
                    {/* Address Text */}
                      ...
                      <div className="grid grid-cols-12 mt-4 gap-5">
                        <div className="box col-span-12 lg:col-span-12 md:col-span-12 ">
                          <h1 className="font-bold">
                            {addrs.addr_country_fk.country_etext}
                          </h1>
                          <h1 className="font-bold">
        ...
        <div className="flex justify-center ">
          <Link
            href={`${process.env.NEXT_PUBLIC_FRONT_END_URL}/customer/cart/${product_id}/all_shipping/shipping`}
          >
            <button
        ...
        <div className="flex flex-row justify-between gap-4 mt-5">
          <Link
            href={`${process.env.NEXT_PUBLIC_FRONT_END_URL}/customer/cart/${product_id}`}
          >
          ...
          <Link
            href={`${process.env.NEXT_PUBLIC_FRONT_END_URL}/customer/cart/${product_id}/all_shipping/${addressId}/`}
          >
            <button className="bg-opacity-20 lg:rounded-full px-6 py-2  bg-[#F21079]">
              
              <FormattedMessage
                id="Choosing a Payment Method"
                values={{ b: (info) => <b>{info}</b> }}
              />
            </button>
          </Link>
